...
module OpenapiClient
  ...
  class PdfSetInfoParameters
    ...
    attr_accessor :clear_empty_values
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfSetInfoParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfSetInfoParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'clear_empty_values')
        self.clear_empty_values = attributes[:'clear_empty_values']
      else
        self.clear_empty_values = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metadata == o.metadata &&
          keywords == o.keywords &&
          clear_empty_values == o.clear_empty_values
    end
    ...
    def hash
      [file_id, author, title, subject, producer, metadata, keywords, clear_empty_values].hash
    end
