...
module OpenapiClient
  ...
  class PdfRotatePageStandardParameters
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfRotatePageStandardParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfRotatePageStandardParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rotation_angle')
        self.rotation_angle = attributes[:'rotation_angle']
      end

      if attributes.key?(:'flip_horizontally')
        self.flip_horizontally = attributes[:'flip_horizontally']
      else
        self.flip_horizontally = false
      end

      if attributes.key?(:'flip_vertically')
        self.flip_vertically = attributes[:'flip_vertically']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flip_horizontally == o.flip_horizontally &&
          flip_vertically == o.flip_vertically
    end
    ...
    def hash
      [file_id, page_range, rotation_angle, flip_horizontally, flip_vertically].hash
    end
