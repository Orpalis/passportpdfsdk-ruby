  ...
  class MICRSymbolInfo
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MICRSymbolInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MICRSymbolInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'symbol_value')
        self.symbol_value = attributes[:'symbol_value']
      end

      if attributes.key?(:'symbol_value2')
        self.symbol_value2 = attributes[:'symbol_value2']
      end
      ...
      if attributes.key?(:'confidence2')
        self.confidence2 = attributes[:'confidence2']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          symbol_value == o.symbol_value &&
          symbol_value2 == o.symbol_value2 &&
          top == o.top &&
          left == o.left &&
          bottom == o.bottom &&
          right == o.right &&
    ...
    def hash
      [symbol_value, symbol_value2, top, left, bottom, right, line, confidence, confidence2].hash
    end
