...
module OpenapiClient
  ...
  class PdfAutoDeskewParameters
    ...
    attr_accessor :max_angle_of_research
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfAutoDeskewParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfAutoDeskewParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_angle_of_research')
        self.max_angle_of_research = attributes[:'max_angle_of_research']
      else
        self.max_angle_of_research = 15
      end

      if attributes.key?(:'optimistic')
        self.optimistic = attributes[:'optimistic']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_angle_of_research == o.max_angle_of_research &&
    ...
    def hash
      [file_id, page_range, max_angle_of_research, optimistic].hash
    end
