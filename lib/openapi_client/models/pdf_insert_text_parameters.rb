...
module OpenapiClient
  ...
  class PdfInsertTextParameters
    ...
    attr_accessor :text_bounding_box_layout
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfInsertTextParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfInsertTextParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'text_bounding_box_layout')
        self.text_bounding_box_layout = attributes[:'text_bounding_box_layout']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          text_bounding_box_layout == o.text_bounding_box_layout
    end
    ...
    def hash
      [file_id, page_range, text_parameters, text_bounding_box_layout].hash
    end
