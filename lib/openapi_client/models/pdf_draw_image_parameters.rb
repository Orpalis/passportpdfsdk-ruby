...
module OpenapiClient
  ...
  class PdfDrawImageParameters
    ...
    attr_accessor :bitonal_compression

    attr_accessor :image_layout
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfDrawImageParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfDrawImageParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'image_file_id')
        self.image_file_id = attributes[:'image_file_id']
      else
        self.image_file_id = ''
      end
      ...
      if attributes.key?(:'bitonal_compression')
        self.bitonal_compression = attributes[:'bitonal_compression']
      end

      if attributes.key?(:'image_layout')
        self.image_layout = attributes[:'image_layout']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          image_file_id == o.image_file_id &&
          quality == o.quality &&
          color_image_compression == o.color_image_compression &&
          bitonal_compression == o.bitonal_compression &&
          image_layout == o.image_layout
    end
    ...
    def hash
      [file_id, page_range, image_data, image_file_id, quality, color_image_compression, bitonal_compression, image_layout].hash
    end
