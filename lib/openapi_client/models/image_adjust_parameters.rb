...
module OpenapiClient
  ...
  class ImageAdjustParameters
    ...
    attr_accessor :auto_contrast_enhancement

    # Specifies whether a contrast histogram stretch filter shall be performed.
    attr_accessor :contrast_histogram_stretch
    ...
    def self.openapi_types
      {
        ...
        :'contrast' => :'Integer',
        :'saturation' => :'Integer',
        :'auto_contrast_enhancement' => :'Boolean',
        :'contrast_histogram_stretch' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ImageAdjustParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ImageAdjustParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gamma_correction')
        self.gamma_correction = attributes[:'gamma_correction']
      else
      ...
      if attributes.key?(:'auto_contrast_enhancement')
        self.auto_contrast_enhancement = attributes[:'auto_contrast_enhancement']
      else
        self.auto_contrast_enhancement = false
      end

      if attributes.key?(:'contrast_histogram_stretch')
        self.contrast_histogram_stretch = attributes[:'contrast_histogram_stretch']
      else
        self.contrast_histogram_stretch = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gamma_correction == o.gamma_correction &&
          brightness == o.brightness &&
          contrast == o.contrast &&
          saturation == o.saturation &&
          auto_contrast_enhancement == o.auto_contrast_enhancement &&
          contrast_histogram_stretch == o.contrast_histogram_stretch
    end
    ...
    def hash
      [file_id, page_range, roi_left, roi_top, roi_width, roi_height, gamma_correction, brightness, contrast, saturation, auto_contrast_enhancement, contrast_histogram_stretch].hash
    end
