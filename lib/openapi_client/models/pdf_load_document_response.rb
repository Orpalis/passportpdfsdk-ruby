...
module OpenapiClient
  ...
  class PdfLoadDocumentResponse
    ...
    attr_accessor :password_is_required
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PdfLoadDocumentResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PdfLoadDocumentResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'password_is_required')
        self.password_is_required = attributes[:'password_is_required']
      end

      if attributes.key?(:'thumbnail_data')
        self.thumbnail_data = attributes[:'thumbnail_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_is_required == o.password_is_required &&
    ...
    def hash
      [error, remaining_tokens, file_id, page_count, encryption, password_is_required, thumbnail_data].hash
    end
